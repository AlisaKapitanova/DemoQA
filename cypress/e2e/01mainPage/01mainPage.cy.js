...
describe("HomePage", () => {
    ...
    it.skip("AT_01.01.01 first  | HomePage > Verify categories name", () => {
        homePage
    ...
    it("AT_01.01.01 second | HomePage > Verify categories name", () => {
        homePage
    ...
    homePageData.cards.categoryCards.forEach((cardName, index) => {
        it("AT_01.01.02 Parametrization | HomePage > Verify card link functionality", function () {
            homePage
